...
{
    public partial class DEencuestaEstudiante : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                //TextBox digitadorTextBox = (TextBox)row.FindControl("txtDigitadorCodigo");

                //digitadorTextBox.Text = "hola";
            }
